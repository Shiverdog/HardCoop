...
execute positioned ~-1.5 ~-1 ~-1.5 as @e[type=item,dx=2,dz=2,dy=3,sort=nearest,limit=1] if entity @s at @s as @a[gamemode=adventure] run function hardcoop:compare_uuid
