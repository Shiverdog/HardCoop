...
execute positioned ~-1.5 ~-1 ~-1.5 as @e[tag=hardcoop_pure_soul,dx=2,dz=2,dy=3,sort=nearest,limit=1] at @s as @r[team=hardcoop_dead] run function hardcoop:internal/revive
