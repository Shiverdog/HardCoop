...
execute as @e[type=item] if entity @s[tag=hardcoop_any_soul] at @s run function hardcoop:internal/soul
execute as @e[type=item] unless entity @s[tag=hardcoop_any_soul] unless entity @s[tag=hardcoop_not_soul] if entity @s[nbt={Item:{id:"minecraft:player_head"}}] at @s run function hardcoop:internal/soul
